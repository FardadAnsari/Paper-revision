...
We trained the proposed \texttt{CLLWCsiNet} model using PyTorch for up to 663 epochs, selecting the best performing model based on validation performance. The training was conducted with a batch size of 200 and a learning rate of 0.001, using the Adam optimizer. 
