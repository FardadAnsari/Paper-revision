...
\section{Conclusion}
In this work, we proposed CLLWCsiNet, a novel deep learning architecture for efficient CSI feedback compression in massive MIMO systems, demonstrating three key advances: (1) Superior noise resilience with -11.2 dB NMSE at critical low-SNR conditions (0-20 dB), outperforming DNNet by 31% through integrated denoising refinement blocks; (2) Hardware-efficient design via convolutional latent-space compression (70K parameters vs. 2.1M in FC-based models) and 8-bit dynamic quantization (<1 dB degradation), enabling practical UE deployment; and (3) Robust generalization across COST2100 and Quadriga datasets (28 GHz/300 MHz), showing only 0.08 dB mmWave degradation versus 1.31 dB for prior art. These innovations address the dual challenges of reliable operation in noisy cell-edge environments (60% of cellular connections per 3GPP TR 38.901) and stringent UE resource constraints. Future work will extend this framework to heterogeneous networks and adaptive quantization for dynamic channel conditions, further bridging the gap between theoretical performance and practical deployment requirements in 5G/6G systems.
