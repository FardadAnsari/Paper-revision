...
Lu \textit{et al.} \cite{prac2024} identify key challenges including channel distribution shifts and propose an alternating optimization framework with online knowledge-review to enhance adaptability. Their solution improves NMSE by 4.3 dB in unseen environments compared to conventional static models.
