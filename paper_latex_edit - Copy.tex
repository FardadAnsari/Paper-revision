...
\subsection{Convolutional Latent-Space}:
...
\subsection{Encoder Compression}
...
\subsection{Denoising Capability}:
...
\begin{table}[ht]
	\centering
	\begin{threeparttable} % <-- Required wrapper
	...
	\hline
	\end{tabular}
	\begin{tablenotes} % <-- Notes section
