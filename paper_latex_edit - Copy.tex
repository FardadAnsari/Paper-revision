...
\cite{li2024lightweight}Proposes GCRNet, a Ghost module-based architecture that reduces feature redundancy in CSI feedback by generating secondary features from primary maps. Achieves 22.15\% lower complexity than \cite{clnet} while maintaining comparable accuracy, addressing efficiency decay in convolution-based methods like \cite{csinet}.
